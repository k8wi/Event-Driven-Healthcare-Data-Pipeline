...
REGION = "us-central1"
CLUSTER_NAME = "medicare-pipeline-cluster-stage4"
...
dag = DAG(
    ...
    description='Stage 4: Load Parquet to BigQuery',
...
spark_job = {
    ...
    "pyspark_job": {
        "main_python_file_uri": "gs://cms-partd-data-demo/scripts/stage_4_load_to_bigquery.py",
    },
}
